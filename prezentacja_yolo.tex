...
\includegraphics[width=5.5cm]{img/object_detection_example.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{img/one-two-stage.png}
\end{center}
...
\includegraphics[width=5cm]{img/labelimg_screenshot.png}\\
\small\textbf{LabelImg} -- prosty, lokalny
...
\includegraphics[width=5cm]{img/cvat_screenshot.png}\\
\small\textbf{CVAT} -- zaawansowany, webowy
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
\begin{center}
...
\includegraphics[width=5cm]{img/roboflow_screenshot.png}\\
\small\textbf{Roboflow} -- chmura, augmentacje
...
\includegraphics[width=5cm]{img/label_studio_screenshot.png}\\
\small\textbf{Label Studio} -- multi-task, ML
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=6cm]{img/augmentation_examples.png}
\end{center}
...
\begin{center}
\includegraphics[width=8cm]{img/transfer_learning_diagram.png}
\end{center}
\end{column}
\begin{column}{0.55\textwidth}
...
\begin{frame}
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{img/underfitting_overfitting_loss.png}
\end{frame}

\begin{frame}{Overfitting -- co robić?}
\begin{columns}
\begin{column}{0.55\textwidth}
    \includegraphics[width=\textwidth]{img/overfitting.png}

    \small Po 9 epoce wyniki testów przestają rosnąć -- overfitting.
\end{column}
\begin{column}{0.45\textwidth}
\textbf{Rozwiązania:}
\begin{itemize}
    \item \textbf{Early stopping} -- \texttt{patience=50}
    \item \textbf{Więcej danych} lub augmentacje
    \item \textbf{Regularyzacja} -- weight decay
    \item \textbf{Dropout} w warstwie head
    \item \textbf{Mniejszy model} (s $\rightarrow$ n)
    \item \textbf{Freeze backbone} -- \texttt{freeze=10}
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=5.5cm]{img/yolo_training_results.png}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
\begin{center}
...
\includegraphics[width=5.5cm]{img/confusion_matrix_example.png}
\end{center}
\end{column}
\end{columns}
