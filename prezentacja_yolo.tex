...
\midrule
\textbf{YOLOv2} (YOLO9000) & 2016 & Batch normalization, anchor boxes, detekcja na wielu skalach, 9000 klas \\
\midrule
...
\begin{center}
\fbox{\parbox{4cm}{\centering\small\textit{Schemat sieci neuronowej}\\[0.2cm]\tiny img/neural\_network\_diagram.png}}
\end{center}
\vspace{0.2cm}
...
\begin{center}
\fbox{\parbox{4.5cm}{\centering\small\textit{Wizualizacja konwolucji}\\[0.2cm]\tiny img/convolution\_visualization.png}}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
...
\begin{itemize}
    ...
    \item Rozmiar filtra (kernel size)
\end{itemize}
\end{column}
\end{columns}
\end{frame}
